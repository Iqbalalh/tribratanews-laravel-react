...
export default function EditorPosts({ auth, editorView }) {
    const [showCreateModal, setShowCreateModal] = useState(false);
    const [showViewModal, setShowViewModal] = useState(false);
    const [showEditModal, setShowEditModal] = useState(false);
    const [editPost, setEditPost] = useState(null);
    const [currentPage, setCurrentPage] = useState(editorView.current_page);

    const onPageChange = (page) => {
        setCurrentPage(page);
        window.location.assign(`${editorView.path}?page=${page}`);
    };
                    ...
                    <div className="crud mt-5 m-10">
                        ...
                        <div className="flex overflow-x-auto sm:justify-center">
                            <Pagination
                                ...
                                totalPages={editorView.last_page}
